...
try:
    ...
    pass
# --- Postura neutra cómoda (brazos abajo, manos semiabiertas) ---
names = [
    "LShoulderPitch","RShoulderPitch","LShoulderRoll","RShoulderRoll",
    "LElbowYaw","RElbowYaw","LElbowRoll","RElbowRoll",
    "LWristYaw","RWristYaw","LHand","RHand","HeadYaw","HeadPitch"
]
target = [1.3, 1.3, 0.1, -0.1, 0.0, 0.0, -0.5, 0.5, 0.0, 0.0, 0.35, 0.35, 0.0, -0.05]
angleLists = [[a] for a in target]
timeLists  = [[1.0] for _ in names]
motion_service.angleInterpolation(names, angleLists, timeLists, 1)

# --- Asentimiento suave de cabeza (2 ciclos) ---
headAngles  = [[-0.05, -0.12,  0.08, -0.05]]
headTimes   = [[ 0.20,  0.60,  1.10,  1.50]]
motion_service.angleInterpolation(["HeadPitch"], headAngles, headTimes, 1)
motion_service.angleInterpolation(["HeadPitch"], headAngles, headTimes, 1)
...
# --- Mirada lateral corta (ida y vuelta) ---
